...
For voiding the singularity of the input~(\ref{eq:u}), the selection of $\alpha$ and $\beta$ may satisfy the condition: $0<\alpha\le\beta$.
    ...
    \end{align*}
    This can guarantee the non-singularity of Eq.~(\ref{eq:u}), because $x_3$ should be varying in a small region with $\vert x_3\vert<\pi/2$.
\end{color}
\begin{theorem}
